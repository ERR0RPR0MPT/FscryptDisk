...
extern "C"
{
    ...
    LONG
        WINAPI
        FscryptDiskShowCPlAppletElevated(HWND hWnd);

    VOID
        WINAPI
        FscryptDiskRelaunchElevated(HWND hWnd, LPCSTR DllFunction,
                                    LPCSTR CommandLine, int nCmdShow);

    VOID
        WINAPI
        FscryptDiskRelaunchElevatedW(HWND hWnd, LPCWSTR DllFunction,
