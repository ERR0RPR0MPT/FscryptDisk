...
Imports LTR.IO.FscryptDisk.Devio.Server.Services
                ...
                Using service
                    ...
                    If mount Then
                        If "#:".Equals(mount_point, StringComparison.Ordinal) Then
                            Dim drive_letter = FscryptDiskAPI.FindFreeDriveLetter()
                        ...
                        service.StartServiceThreadAndMountFscryptDisk(FscryptDiskFlags.Auto, mount_point)
