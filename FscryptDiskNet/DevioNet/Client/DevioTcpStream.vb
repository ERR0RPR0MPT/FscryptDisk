    ...
    Public Class DevioTcpStream
        ...
        Public Sub New(name As String, [readOnly] As Boolean)
            ...
            Try
                ...
                Writer.Write(FSCRYPTDPROXY_REQ.FSCRYPTDPROXY_REQ_INFO)
                Writer.Flush()
                ...
                Flags = Flags Or CType(Reader.ReadInt64(), FSCRYPTDPROXY_FLAGS)
        ...
        Public Overrides Function Read(buffer As Byte(), offset As Integer, count As Integer) As Integer
            ...
            Writer.Write(FSCRYPTDPROXY_REQ.FSCRYPTDPROXY_REQ_READ)
        ...
        Public Overrides Sub Write(buffer As Byte(), offset As Integer, count As Integer)
            ...
            Writer.Write(FSCRYPTDPROXY_REQ.FSCRYPTDPROXY_REQ_WRITE)
            Writer.Write(Position)
            Writer.Write(CLng(count))
