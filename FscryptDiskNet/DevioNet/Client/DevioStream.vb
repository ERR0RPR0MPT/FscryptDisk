...
Namespace Client
    ...
    ''' <summary>
    ''' Base class for classes that implement Stream for client side of FscryptDisk/Devio protocol.
    ''' </summary>
    Public MustInherit Class DevioStream
        ...
        ''' <summary>
        ''' FscryptDisk proxy flags specified for proxy connection.
        ''' </summary>
        Protected Property Flags As FSCRYPTDPROXY_FLAGS
        ...
        Protected Sub New(name As String, [readOnly] As Boolean)
            ...
            ObjectName = name
            If [readOnly] Then
                Flags = FSCRYPTDPROXY_FLAGS.FSCRYPTDPROXY_FLAG_RO
            End If
        End Sub

        ''' <summary>
        ''' Indicates whether Stream is readable. This implementation returns a
        ''' constant value of True, because FscryptDisk/Devio proxy implementations are
        ''' always readable.
        ''' </summary>
        ...
        ''' unless ProxyFlags property contains FSCRYPTDPROXY_FLAGS.FSCRYPTDPROXY_FLAG_RO value.
        ''' </summary>
        Public Overrides ReadOnly Property CanWrite As Boolean
            Get
                Return (Flags And FSCRYPTDPROXY_FLAGS.FSCRYPTDPROXY_FLAG_RO) = 0
            End Get
        End Property
        ...
        ''' FscryptDisk proxy flags specified for proxy connection.
        ''' </summary>
        Public ReadOnly Property ProxyFlags As FSCRYPTDPROXY_FLAGS
            Get
                Return Flags
            End Get
        End Property
