...
Namespace Server.Services
    ...
    ''' FscryptDisk/Devio communication. Derived classes implement communication mechanisms and
    ...
    Public MustInherit Class DevioServiceBase
        ...
        ''' <summary>
        ''' Event raised when an FscryptDisk Virtual Disk Device is created by with this instance.
        ''' </summary>
        Public Event FscryptDiskCreated As Action
        Protected Overridable Sub OnFscryptDiskCreated()
            RaiseEvent FscryptDiskCreated()
        End Sub
        ...
        ''' but before associated virtual disk device is forcefully removed, as specified by ForceRemoveFscryptDiskDeviceOnCrash
        ''' property.
        ''' </summary>
        ...
        Protected Overridable Sub OnServiceUnhandledException(e As UnhandledExceptionEventArgs)
            ...
            Try
                If HasFscryptDiskDevice AndAlso ForceRemoveFscryptDiskDeviceOnCrash Then
                    FscryptDiskAPI.ForceRemoveDevice(FscryptDiskDeviceNumber)
                End If
        ...
        Protected Overridable Function GetDeviceReader() As UnsafeNativeMethods.FscryptDiskReadFileUnmanagedProc
        ...
        Public Overridable Function GetPartitionInformation() As ReadOnlyCollection(Of NativeFileIO.UnsafeNativeMethods.PARTITION_INFORMATION)
            ...
            Return FscryptDiskAPI.GetPartitionInformation(Nothing, GetDeviceReader(), SectorSize, Offset)

        End Function

        ''' <summary>
        ''' When overridden in a derived class, runs service that acts as server end in FscryptDisk/Devio communication. It will
        ...
        ''' <summary>
        ''' Combines a call to StartServiceThread() with a call to FscryptDiskAPI to create a proxy type
        ''' FscryptDisk Virtual Disk Device that uses the started service as storage backend.
        ''' </summary>
        ''' <param name="Flags">Flags to pass to FscryptDiskAPI.CreateDevice() combined with fixed flag
        ...
        ''' need to be specified in this parameter. A common value to pass however, is FscryptDiskFlags.ReadOnly
        ...
        Public Overridable Sub StartServiceThreadAndMountFscryptDisk(Flags As FscryptDiskFlags, MountPoint As String)
            ...
            Try
                FscryptDiskAPI.CreateDevice(DiskSize,
                                       0,
                                       0,
                                       SectorSize,
                                       Offset,
                                       Flags Or FscryptDiskAdditionalFlags Or FscryptDiskProxyModeFlags,
                                       FscryptDiskProxyObjectName,
                                       False,
                                       MountPoint,
                                       _FscryptDiskDeviceNumber,
                                       Nothing)

                OnFscryptDiskCreated()
        ...
        ''' <summary>
        ''' Dismounts an FscryptDisk Virtual Disk Device created by StartServiceThreadAndMountFscryptDisk() and waits
        ''' for service thread of this instance to exit.
        ''' </summary>
        Public Overridable Sub DismountFscryptDiskAndStopServiceThread()

            Dim i = 1
            Do
                Try
                    FscryptDiskAPI.RemoveDevice(_FscryptDiskDeviceNumber)
                    _FscryptDiskDeviceNumber = UInteger.MaxValue
                    Exit Do
        ...
        ''' <summary>
        ''' Additional flags that will be passed to FscryptDiskAPI.CreateDevice() in StartServiceThreadAndMountFscryptDisk()
        ''' method. Default value of this property depends on derived class and which parameters are normally
        ''' needed for FscryptDisk to start communication with this service.
        ''' </summary>
        ''' <value>Default value of this property depends on derived class and which parameters are normally
        ''' needed for FscryptDisk to start communication with this service.</value>
        ''' <returns>Default value of this property depends on derived class and which parameters are normally
        ''' needed for FscryptDisk to start communication with this service.</returns>
        Public Overridable Property FscryptDiskAdditionalFlags As FscryptDiskFlags

        ''' <summary>
        ''' When overridden in a derived class, indicates additional flags that will be passed to
        ''' FscryptDiskAPI.CreateDevice() in StartServiceThreadAndMountFscryptDisk() method. Value of this property depends
        ''' on derived class and which parameters are normally needed for FscryptDisk to start communication with this
        ''' service.
        ''' </summary>
        ''' <value>Default value of this property depends on derived class and which parameters are normally
        ''' needed for FscryptDisk to start communication with this service.</value>
        ''' <returns>Default value of this property depends on derived class and which parameters are normally
        ''' needed for FscryptDisk to start communication with this service.</returns>
        Protected MustOverride ReadOnly Property FscryptDiskProxyModeFlags As FscryptDiskFlags

        ''' <summary>
        ''' Object name that FscryptDisk Virtual Disk Driver can use to connect to this service.
        ''' </summary>
        ''' <value>Object name string.</value>
        ''' <returns>Object name that FscryptDisk Virtual Disk Driver can use to connect to this service.</returns>
        Protected MustOverride ReadOnly Property FscryptDiskProxyObjectName As String

        Private _FscryptDiskDeviceNumber As UInteger = UInteger.MaxValue

        ''' <summary>
        ''' After successful call to StartServiceThreadAndMountFscryptDisk(), this property returns FscryptDisk device
        ''' number for created FscryptDisk Virtual Disk Device. This number can be used when calling FscryptDisk API
        ''' functions. If no FscryptDisk Virtual Disk Device has been created by this instance, an exception is
        ''' thrown. Use HasFscryptDiskDevice property to find out if an FscryptDisk device has been created.
        ''' </summary>
        ''' <value>FscryptDisk device
        ''' number for created FscryptDisk Virtual Disk Device.</value>
        ''' <returns>FscryptDisk device
        ''' number for created FscryptDisk Virtual Disk Device.</returns>
        ''' <remarks></remarks>
        Public Overridable ReadOnly Property FscryptDiskDeviceNumber As UInteger
            Get
                If _FscryptDiskDeviceNumber = UInteger.MaxValue Then
                    Throw New InvalidOperationException("No FscryptDisk Virtual Disk Device currently associated with this instance.")
                End If
                Return _FscryptDiskDeviceNumber
            End Get
        End Property

        ''' <summary>
        ''' Use HasFscryptDiskDevice property to find out if an FscryptDisk device has been created in a call to
        ''' StartServiceThreadAndMountFscryptDisk() method. Use FscryptDiskDeviceNumber property to find out FscryptDisk
        ''' device number for created device.
        ''' </summary>
        ''' <value>Returns True if an FscryptDisk Virtual Disk Device has been created, False otherwise.</value>
        ''' <returns>Returns True if an FscryptDisk Virtual Disk Device has been created, False otherwise.</returns>
        Public Overridable ReadOnly Property HasFscryptDiskDevice As Boolean
            Get
                Return _FscryptDiskDeviceNumber <> UInteger.MaxValue
            End Get
        End Property

        ''' <summary>
        ''' Indicates whether FscryptDisk Virtual Disk Device created by this instance will be automatically
        ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.
        ''' </summary>
        ''' <value>Indicates whether FscryptDisk Virtual Disk Device created by this instance will be automatically
        ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.</value>
        ''' <returns>Indicates whether FscryptDisk Virtual Disk Device created by this instance will be automatically
        ''' forcefully removed if a crash occurs in service thread of this instance. Default is True.</returns>
        Public Overridable Property ForceRemoveFscryptDiskDeviceOnCrash As Boolean = True
        ...
        Protected Overridable Sub Dispose(disposing As Boolean)
            If Not Me.disposedValue Then
                ...
                If ServiceThread.ManagedThreadId <> Thread.CurrentThread.ManagedThreadId Then
                    If HasFscryptDiskDevice Then
                        DismountFscryptDiskAndStopServiceThread()
                    Else
                        OnStopServiceThread()
                        WaitForServiceThreadExit()
                    End If
