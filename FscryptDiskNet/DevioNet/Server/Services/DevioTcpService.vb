...
Namespace Server.Services
    ...
    ''' <summary>
    ''' Class that implements server end of FscryptDisk/Devio TCP/IP based communication protocol.
    ...
    Public Class DevioTcpService
        ...
        ''' <summary>
        ''' Runs service that acts as server end in FscryptDisk/Devio TCP/IP based communication. It will first wait for
        ...
        Public Overrides Sub RunService()
            ...
            Try
                ...
                Do
                    ...
                    Dim RequestCode As FSCRYPTDPROXY_REQ

                    Try
                        RequestCode = CType(Reader.ReadUInt64(), FSCRYPTDPROXY_REQ)
        ...
        Private Sub SendInfo(Writer As BinaryWriter)
            ...
            Writer.Write(CULng(If(DevioProvider.CanWrite, FSCRYPTDPROXY_FLAGS.FSCRYPTDPROXY_FLAG_NONE, FSCRYPTDPROXY_FLAGS.FSCRYPTDPROXY_FLAG_RO)))
        ...
        Protected Overrides ReadOnly Property FscryptDiskProxyModeFlags As FscryptDiskFlags
            Get
                Return FscryptDiskFlags.TypeProxy Or FscryptDiskFlags.ProxyTypeTCP
            End Get
        End Property
